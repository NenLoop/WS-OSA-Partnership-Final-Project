...
//             Dedicated to forming innovators who are academically excellent,
//             socially responsible, and rounded in faith.
//           </p>
...
//         <h3
//           style={{ letterSpacing: "4px", color: "#666", fontStyle: "italic" }}
//         >
...
//                 International maritime experts express trust that the academic
//                 force of the college will enforce leadership and discipline...
//               </p>
//             </div>
//           </div>
...
const LandingPage = () => {
  return (
    <div>
      ...
      {/* Landing page implementation goes here */}
    </div>
  );
};
